...
function(core_dependency_std_pipeline_download_and_unzip_ffmpeg_prebuilt_and_create_ffmpeg_target)
    ...
    if(NOT PIPELINE_FILENAME)
        set(PIPELINE_FILENAME "ffmpeg-n8.1-latest-win64-gpl-shared-8.1.zip")
    endif()
    
    # set default DOWNLOAD_DIR
    if(NOT PIPELINE_DOWNLOAD_DIR)
        set(PIPELINE_DOWNLOAD_DIR "${CMAKE_BINARY_DIR}/downloads")
    endif()
    ...
    # set default IS_SILENT_MODE
    if(NOT PIPELINE_IS_SILENT_MODE)
        set(PIPELINE_IS_SILENT_MODE "FALSE")
    endif()
    
    # set default IS_GLOBAL_MODE
    if(NOT PIPELINE_IS_GLOBAL_MODE)
        set(PIPELINE_IS_GLOBAL_MODE "FALSE")
    endif()
...
# Example 1: Basic usage (uses all defaults)
