# ====== core_dependency_std_backend_fetch_content_cpp_tools.cmake
# ====================================
#		explanation
# ====================================
...
#       return variables
# ====================================
# RETURN_VAR_PREFIX = CORE_DEPENDENCY_STD_BACKEND_FETCH_CONTENT_CPP_TOOLS
...
function(core_dependency_std_backend_fetch_content_cpp_tools)
	...
	#       return variables
	# ====================================
	set(RETURN_VAR_PREFIX  CORE_DEPENDENCY_STD_BACKEND_FETCH_CONTENT_CPP_TOOLS  )
	...
	set(${RETURN_VAR_PREFIX}_REPOSITORY_URL
		"https://github.com/jtl0079/cpp_tools.git"
		PARENT_SCOPE
	)

	set(${RETURN_VAR_PREFIX}_GIT_TAG
		"${ARG_GIT_TAG}"
		PARENT_SCOPE
	)

	set(${RETURN_VAR_PREFIX}_SOURCE_DIR
		"${cpp_tools_SOURCE_DIR}"
		PARENT_SCOPE
	)

	set(${RETURN_VAR_PREFIX}_BINARY_DIR
